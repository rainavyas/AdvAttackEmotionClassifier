"""
PyTorch Model Wrapper - variant of code from: https://github.com/QData/TextAttack/blob/master/textattack/models/wrappers/pytorch_model_wrapper.py

I think there was an error in the use of the tokenizer function lines 41 and 42
--------------------------
"""
...
class PyTorchModelWrapper(ModelWrapper):
    ...
    def get_grad(self, text_input, loss_fn=CrossEntropyLoss()):
        ...
        model_device = next(self.model.parameters()).device
        ids = self.tokenizer([text_input]) # Won't work for me
